...
export const r61ManufacturingTextureMaterials = {
  ...
  Metal_Painted_Charcoal: "painted-charcoal",
  Metal_Steel: "steel",
  Metal_Aluminum: "aluminum",
  Panel_White: "panel-white",
  Safety_Amber: "safety-amber",
  Rubber: "rubber",
} as const;
...
export const r61MaterialNormalScale: Record<string, number> = {
  Concrete_Floor: 0.18, Concrete_Wall: 0.16, Metal_Painted_Charcoal: 0.10,
  Metal_Steel: 0.08, Metal_Aluminum: 0.08, Panel_White: 0.06,
  Safety_Amber: 0.06, Rubber: 0.08,
};
export const r61GlassMaterials = new Set<string>([
  "Glass_Clear", "Glass_Tinted", "VisionGlass", "Glass_Industrial",
]);
export function r61MaterialTextureUrl(hero: R6HeroId, material: R61ManufacturingMaterialName, kind: R61TextureKind) {
